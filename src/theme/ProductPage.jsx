...
function Product(props){
    ...
    <Row >
      ...
      <Col xs={6} style={{paddingLeft:'0', imageWidth:'100%', width:'675px'}}><img style={{width:'100%', maxHeight:'1200px', paddingBottom:'15px'}} src={props.painting.pic} alt={props.painting.name}/></Col>
